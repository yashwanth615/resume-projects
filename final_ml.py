...
# prompt: /content/train_features.csv in tthese label column,there is value is 1 or 2 ,we have to covert 1 to 0,and 2 to 1 ,update that in the same csv file
...
# prompt: move this file /content/test_features.csv to /content/drive/MyDrive/ml_proj
...
# Instead of using all models in stacking, let's evaluate each one separately first
models = {
